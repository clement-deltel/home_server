...
alias cditt='cd ${SERVER_HOME}/services/management/code/it-tools'
...
alias cdenc='cd ${SERVER_HOME}/services/security/enclosed'
...
alias svcitt='cd ${SERVER_HOME}/services/management/code/it-tools'
...
alias svcenc='cd ${SERVER_HOME}/services/security/enclosed'
